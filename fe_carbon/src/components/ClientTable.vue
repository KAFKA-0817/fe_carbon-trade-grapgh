<template>
  ...
  <el-dialog v-model="addDialogVisible" title="Shipping address">
    <el-form :model="addForm">
      ...
      <el-form-item label="demand" :label-width="formLabelWidth">
        <el-input v-model="addForm.demand" autocomplete="off" size="small" />
      </el-form-item>
  ...
  <el-dialog v-model="editDialogVisible" title="Shipping address">
    <el-form :model="editForm">
      ...
      <el-form-item label="demand" :label-width="formLabelWidth">
        <el-input v-model="editForm.demand" autocomplete="off" size="small" />
      </el-form-item>
      <el-form-item label="x" :label-width="formLabelWidth">

                ...
                <el-table :data="tableData" stripe style="width: 100%">
                    ...
                    <el-table-column fixed="right" label="Operations" width="120">
                        <template #default="scope">
                            <el-button link type="primary" size="small" @click="handleGraph(scope)">graph</el-button>
                            <el-button link type="danger" size="small" @click="handleDelete(scope)">Delete</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-main>
    ...
    <el-dialog v-model="graphDialogVisible" title="事务路径图">
        ...
        <template #footer>
            <span class="dialog-footer">
                ...
                <el-button type="primary" @click="graphDialogVisible = false"> OK </el-button>
            </span>
        </template>
    </el-dialog>
</template>
